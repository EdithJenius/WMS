...
export default function PurchaseForm({ onRefresh, user }: PurchaseFormProps) {
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="boxesPerCase">一箱几端</Label>
                        <Input
                          id="boxesPerCase"
                          type="number"
                          value={newProduct.boxesPerCase || ''}
                          onChange={(e) => handleNewProductChange('boxesPerCase', parseInt(e.target.value) || null)}
                          placeholder="如：4"
                        />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="boxesPerSet">一端几盒</Label>
                        <Input
                          id="boxesPerSet"
                          type="number"
                          value={newProduct.boxesPerSet || ''}
                          onChange={(e) => handleNewProductChange('boxesPerSet', parseInt(e.target.value) || null)}
                          placeholder="如：12"
                        />
                      </div>
                    </div>
